...
def menu_builder(request):
    ...
    return render(request, 'vendor/menu_builder.html', content)
...
def edit_food(request, pk=None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save()
            messages.success(request, 'Category updated successfully!')
            return redirect('vendor:fooditems_by_category', foodtitle.category.id)
        else:
            print(form.errors)
